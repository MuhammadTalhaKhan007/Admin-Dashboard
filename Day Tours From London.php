...
<div class="side-menu" id="side-menu">
       ...
       <div class="header">
            <h1>Day Tours from London</h1>
        </div> 
         <!-- Day Tours From London Content start from here -->
    <div class="content">
            <div class="cards">
    <div>
        <div class="MainContainer" id="Create">
            <div class="ListTab">
                <div class="Tabs">
                    <div class="TourTitle">
                        <h2>Wanna Create new Day Tour from London?</h2>
                    </div>
    ...
    $sql1 = "SELECT * FROM tours WHERE Tour_Type = 'Day Tours From London'";
    ...
    <div class='ListTab'>
        <div class='Tabs'>
            ...
            <div class='TourButton'>
                ...
                <button id='DeleteButton' onclick='location.href=\"Delete Day Tours From London.php?id=" . $row['id'] . "\"'>Delete</button>
            </div>
        </div>
    </div>
</div>";
    ...
    <form action="Day Tours From London.php" method="POST" enctype="multipart/form-data">
        <h4>Create New Day Tour From London</h4>
...
<div id="myUpdateForm">
    ...
    <form action="Day Tours From London.php" method="POST">
...
if(isset($_POST['title']) || isset($_POST['description']) || isset($_POST['transport']) || isset($_POST['duration']) || isset($_POST['price1']) || isset($_FILES['image']))
{
    ...
    if ($_FILES['image']['error'] === UPLOAD_ERR_OK)
    {
        ...
        if ($stmt->execute())
        {
            echo "<script>alert('Day Tour From London has been created successfully!')</script>";
            echo '<script>window.location.href="Day Tours From London.php"</script>';
        }
        else
        {
