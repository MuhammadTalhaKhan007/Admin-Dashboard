...
<div class="side-menu" id="side-menu">
       ...
       <div class="header">
            <h1>Overnight Tour </h1>
        </div> 
      <!-- Overnight Tours Content start from here -->    
      <div class="content">
            <div class="cards">
     <div id="content4">
        <div class="MainContainer" id="Create">
            <div class="ListTab">
                <div class="Tabs">
                    <div class="TourTitle">
                        <h2>Wanna Create new Overnight Tour?</h2>
                    </div>
    ...
    $sql1 = "SELECT * FROM tours WHERE Tour_Type = 'Overnight Tours'";
        ...
        <div class='ListTab'>
            <div class='Tabs'>
                ...
                <div class='TourButton'>
                    ...
                    <button id='DeleteButton' onclick='location.href=\"Delete Overnight Tours.php?id=" . $row['id'] . "\"'>Delete</button>
                </div>
            </div>
        </div>
    </div>";
    ...
    <form action="Overnight Tours.php" method="POST" enctype="multipart/form-data">
        <h4>Create New Overnight Tour</h4>
...
<div id="myUpdateForm">
    ...
    <form action="Overnight Tours.php" method="POST">
...
if(isset($_POST['title']) || isset($_POST['description']) || isset($_POST['transport']) || isset($_POST['duration']) || isset($_POST['price1']) || isset($_FILES['image']))
{
    ...
    if ($_FILES['image']['error'] === UPLOAD_ERR_OK)
    {
        ...
        if ($stmt->execute())
        {
            echo "<script>alert('Overnight Tour has been created successfully!')</script>";
            echo '<script>window.location.href="Overnight Tours.php"</script>';
        }
        else
        {
